    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                ...
                $ns1 = new Mahasiswa("0110221252", "Jakiati Rifqoh Assalwa Koswara", "TI", 2021, 3.8, "Cum Laude");
                $ns2 = new Mahasiswa("0110221212", "Muhammad Ramdan", "TI", 2021, 3, "Memuaskan");
                $ns3 = new Mahasiswa("0110221213", "Kholilah Fatmawati", "SI", 2021, 4, "Cum Laude");
                $ns4 = new Mahasiswa("0110221214", "Haykal Akbar", "SI", 2021, 3.4, "Memuaskan");
